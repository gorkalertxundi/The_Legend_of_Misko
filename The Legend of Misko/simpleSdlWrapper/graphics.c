...
int sgHasieratu()
{
  ...
  atexit(SDL_Quit);
  window = SDL_CreateWindow("The Legend of Misko and the Godfather Jones", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
  icon = SDL_LoadBMP(iconoa);
